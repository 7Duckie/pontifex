 ...
 * {@see BackupPage}'s and {@see VerifyPage}'s; folding the shared backup-list
 * rendering into one place is a candidate later tidy.
 *
 ...
 * upload time, not the source site's export time. STAMP_FORMAT is kept
 * regardless: {@see self::archive_when()} still relies on it to format the
 * safety archive's own filename-derived time — a different, still-honest case
 * (this site wrote that file itself, seconds before the restore it protects).
 */
