...
**Status: v1.0.1, released.** The public API is
...
revision. v1.0.0 was the first stable release; v1.0.1 is a security and
correctness patch on top of it. Pontifex is being submitted to the
...
v0.1.0 through v1.0.1 have shipped — round-trip baseline, verification and
...
destinations, the v1.0.0 stable surface, and the v1.0.1 security and
correctness patch.
